...
try {    
    ...
    function setTheme(theme) {
        ...
        switch (theme) {
            case "style-dark":
                bootstarpHref =  `~/Content/assets/css/bootstrap-dark.min.css`
                styleHref = "~/Content/assets/css/style-dark.min.css"
                break;
                case "style-rtl":
                bootstarpHref =  `~/Content/assets/css/bootstrap-rtl.min.css`
                styleHref = "~/Content/assets/css/style-rtl.min.css"
                break;
                case "style-dark-rtl":
                bootstarpHref =  `~/Content/assets/css/bootstrap-dark-rtl.min.css`
                styleHref = "~/Content/assets/css/style-dark-rtl.min.css"
                break;               
        
            default:
                bootstarpHref =  `~/Content/assets/css/bootstrap.min.css`
                styleHref = "~/Content/assets/css/style.min.css"
                break;
        }
